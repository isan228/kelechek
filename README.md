...
Оплата в разработке — мок (`MOCK_PAYMENTS=true`): начисление сразу, без банка. OTP печатается в логе API и на экране входа (`OTP_DEV_ECHO=true`).
...
- Вход по OTP, язык ru/ky в профиле
